...
export async function findWeaponsByTraits(traitHash1, traitHash2) {
...
export async function findPlugSetsByWeapon(weaponsFound) {
...
export async function findPlugItemByPlugSet(plugSetsFound) {
    const result = {};
